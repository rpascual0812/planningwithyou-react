...
export const historyPaths = {
  ...
  bookingStatus: (id: number) => `/quotation-statuses/${id}/history/`,
  bookingItem: (id: number) => `/quotation-items/${id}/history/`,
  formTemplate: (id: number) => `/form-templates/${id}/history/`,
  emailTemplateUsers: (id: number) => `/email-templates/users/${id}/history/`,
  emailTemplateBookings: (id: number) => `/email-templates/quotations/${id}/history/`,
